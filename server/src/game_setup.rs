...
use crate::structure::{Structure, log_gain_structure};
...
pub fn setup_game_with_cache(setup: &GameSetup, cache: Cache) -> Game {
    ...
    execute_setup_round(setup, &mut game, &map_setup);
    game
}
