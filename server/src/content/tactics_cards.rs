...
pub(crate) fn peltasts() -> TacticsCardFactory {
    |id| {
        TacticsCard::builder(
            id,
            "Peltasts",
...
pub(crate) fn encircled() -> TacticsCardFactory {
    |id| {
        TacticsCard::builder(
            id,
            "Encircled",
...
pub(crate) fn wedge_formation() -> TacticsCardFactory {
    |id| {
        TacticsCard::builder(
            id,
            "Wedge Formation",
...
pub(crate) fn high_morale() -> TacticsCardFactory {
    |id| {
...
pub(crate) fn heavy_resistance() -> TacticsCardFactory {
    |id| {
        TacticsCard::builder(
            id,
            "Heavy Resistance",
...
pub(crate) fn high_ground() -> TacticsCardFactory {
    |id| {
        TacticsCard::builder(
            id,
            "High Ground",
...
pub(crate) fn surprise() -> TacticsCardFactory {
    |id| {
        TacticsCard::builder(
            id,
            "Surprise",
...
pub(crate) fn siege() -> TacticsCardFactory {
    |id| {
        ...
        .add_payment_request_listener(
            ...
            0,
            move |_game, p, s| {
                s.is_active(p, id, TacticsCardTarget::Opponent)
