...
pub(crate) fn get_map_setup(player_count: usize) -> MapSetup {
    let setup = vec![
        ...
        MapSetup::new(
            vec![
                MapHomePosition::new(Position::from_offset("D1"), 0, STARTING_BLOCKS[0].clone()),
                MapHomePosition::new(Position::from_offset("D16"), 3, STARTING_BLOCKS[0].clone()),
                MapHomePosition::new(Position::from_offset("D10"), 3, STARTING_BLOCKS[0].clone()),
                MapHomePosition::new(Position::from_offset("D13"), 3, STARTING_BLOCKS[0].clone()),
            ],
            vec![
                BlockPosition::new(Position::from_offset("B2"), 0),
                BlockPosition::new(Position::from_offset("F2"), 0),
