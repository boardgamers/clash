...
fn test_militia() {
    JSON.test("militia", vec![
        TestAction::undoable(0, Action::Playing(PlayingAction::ActionCard(37))).without_json_comparison(),
        TestAction::undoable(
            0,
            Action::Response(EventResponse::Payment(vec![ResourcePile::culture_tokens(
                1,
...
fn test_tech_trade() {
    JSON.test("tech_trade", vec![
        TestAction::undoable(0, Action::Playing(PlayingAction::ActionCard(39))).without_json_comparison(),
        TestAction::undoable(
            0,
            Action::Response(EventResponse::Payment(vec![ResourcePile::culture_tokens(
                1,
