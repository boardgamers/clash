...
#[test]
fn test_lighthouse() {
    JSON.test("lighthouse", vec![
        TestAction::undoable(0, Action::Playing(WonderCard(Wonder::GreatLighthouse))).skip_json(),
