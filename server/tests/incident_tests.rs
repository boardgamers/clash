...
fn test_barbarians_spawn() {
    JSON.test("barbarians_spawn", vec![
...
fn test_barbarians_attack() {
    JSON.test("barbarians_attack", vec![TestAction::not_undoable(
        0,
        Action::Response(EventResponse::SelectAdvance(Advance::Storage)),
    )]);
}
...
fn test_barbarians_recapture_city() {
    JSON.test("barbarians_recapture_city", vec![TestAction::not_undoable(
        0,
...
#[test]
fn test_famine() {
    FAMINE.test("famine", vec![TestAction::not_undoable(
        0,
...
fn test_successful_year() {
    GOOD_YEAR.test("successful_year", vec![TestAction::not_undoable(
        0,
        Action::Response(EventResponse::SelectAdvance(Advance::Storage)),
    )]);
}
...
#[test]
fn test_earthquake() {
    EARTHQUAKE.test("earthquake", vec![
        TestAction::not_undoable(0, advance_action(Advance::Storage, ResourcePile::gold(2)))
            .skip_json(),
        TestAction::undoable(
            0,
...
#[test]
fn test_migration() {
    CIVIL_WAR.test("migration", vec![TestAction::not_undoable(
        0,
        advance_action(Advance::Storage, ResourcePile::gold(2)),
    )]);
}
...
#[test]
fn test_civil_war() {
    CIVIL_WAR.test("civil_war", vec![TestAction::not_undoable(
        0,
        advance_action(Advance::Storage, ResourcePile::gold(2)),
    )]);
}
...
#[test]
fn test_revolution() {
    CIVIL_WAR.test("revolution", vec![
        TestAction::not_undoable(0, advance_action(Advance::Storage, ResourcePile::gold(2)))
            .skip_json(),
        TestAction::undoable(0, Action::Response(EventResponse::SelectUnits(vec![3]))).skip_json(),
        TestAction::undoable(0, Action::Response(EventResponse::SelectUnits(vec![]))).skip_json(),
        TestAction::undoable(
            0,
...
fn test_scientific_trade() {
    TRADE.test("scientific_trade", vec![TestAction::not_undoable(
        0,
        advance_action(Advance::Storage, ResourcePile::gold(2)),
    )]);
}
...
fn test_flourishing_trade() {
    TRADE.test("flourishing_trade", vec![TestAction::not_undoable(
        0,
        advance_action(Advance::Storage, ResourcePile::gold(2)),
    )]);
}
...
fn test_era_of_stability() {
    TRADE.test("era_of_stability", vec![
        TestAction::not_undoable(0, advance_action(Advance::Storage, ResourcePile::gold(2))),
        TestAction::not_undoable(
            0,
...
#[test]
fn test_black_death() {
    PANDEMICS.test("black_death", vec![
        TestAction::not_undoable(0, advance_action(Advance::Storage, ResourcePile::gold(2))),
        TestAction::undoable(0, Action::Response(EventResponse::SelectUnits(vec![0]))),
    ]);
}
...
#[test]
fn test_vermin() {
    PANDEMICS.test("vermin", vec![TestAction::not_undoable(
        0,
        advance_action(Advance::Storage, ResourcePile::gold(2)),
    )]);
}
...
#[test]
fn test_drought() {
    PANDEMICS.test("drought", vec![TestAction::not_undoable(
        0,
        advance_action(Advance::Storage, ResourcePile::gold(2)),
    )]);
}
