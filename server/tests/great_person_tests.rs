...
fn test_great_explorer() {
    GREAT_PERSONS.test("great_explorer", vec![
...
fn test_great_artist() {
    GREAT_PERSONS.test("great_artist", vec![
...
fn test_great_prophet() {
    GREAT_PERSONS.test("great_prophet", vec![
        TestAction::not_undoable(0, advance_action(Advance::Storage, ResourcePile::food(2)))
            .skip_json(),
...
fn test_great_warlord() {
    GREAT_PERSONS.test("great_warlord", vec![
        TestAction::not_undoable(1, advance_action(Advance::Storage, ResourcePile::food(2)))
            .skip_json(),
        TestAction::undoable(1, payment_response(ResourcePile::culture_tokens(1))).skip_json(),
...
fn test_great_merchant() {
    GREAT_PERSONS.test("great_merchant", vec![
        TestAction::not_undoable(0, advance_action(Advance::Storage, ResourcePile::food(2)))
            .skip_json(),
        TestAction::undoable(0, payment_response(ResourcePile::culture_tokens(1))).skip_json(),
...
fn test_great_engineer() {
    GREAT_PERSONS.test("great_engineer", vec![
        TestAction::not_undoable(0, advance_action(Advance::Storage, ResourcePile::food(2)))
            .skip_json(),
        TestAction::undoable(0, payment_response(ResourcePile::culture_tokens(1))).skip_json(),
...
fn test_great_architect() {
    GREAT_PERSONS.test("great_architect", vec![
        TestAction::not_undoable(0, advance_action(Advance::Storage, ResourcePile::food(2)))
            .skip_json(),
        TestAction::undoable(0, payment_response(ResourcePile::culture_tokens(1))).skip_json(),
...
fn test_great_athlete() {
    GREAT_PERSONS.test("great_athlete", vec![
        TestAction::not_undoable(0, advance_action(Advance::Storage, ResourcePile::food(2)))
            .skip_json(),
        TestAction::undoable(0, payment_response(ResourcePile::culture_tokens(1))).skip_json(),
...
fn test_great_diplomat() {
    ...
    GREAT_PERSONS.test("great_diplomat", vec![
        TestAction::not_undoable(0, advance_action(Advance::Storage, ResourcePile::food(2)))
            .skip_json(),
        TestAction::undoable(0, payment_response(ResourcePile::culture_tokens(1))).skip_json(),
        TestAction::not_undoable(
...
#[test]
fn test_great_seer() {
    GREAT_PERSONS.test("great_seer", vec![
        TestAction::not_undoable(0, advance_action(Advance::Storage, ResourcePile::food(2)))
            .skip_json(),
        TestAction::undoable(0, payment_response(ResourcePile::culture_tokens(1))).skip_json(),
        TestAction::not_undoable(0, Action::Playing(PlayingAction::ActionCard(158))).skip_json(),
        TestAction::undoable(
            0,
